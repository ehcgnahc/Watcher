...
cpu_label = tkinter.Label(window, text="CPU: ", font=("Arial", 12), bg="black", fg="white")
cpu_label.pack()
memory_label = tkinter.Label(window, text="記憶體: ", font=("Arial", 12), bg="black", fg="white")
memory_label.pack()
disk_label = tkinter.Label(window, text="硬碟: ", font=("Arial", 12), bg="black", fg="white")
disk_label.pack()
bytes_sent_label = tkinter.Label(window, text="封包發送: ", font=("Arial", 12), bg="black", fg="white")
bytes_sent_label.pack()
bytes_recv_label = tkinter.Label(window, text="封包接收: ", font=("Arial", 12), bg="black", fg="white")
