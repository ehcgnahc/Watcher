...
cpu_label = tkinter.Label(window, text="CPU: ", font=("Arial", 16), anchor='w',bg="black", fg="orange")
cpu_label.pack()
memory_label = tkinter.Label(window, text="RAM: ", font=("Arial", 16), anchor='w', bg="black", fg="orange")
memory_label.pack()
disk_label = tkinter.Label(window, text="DISK: ", font=("Arial", 16), anchor='w', bg="black", fg="orange")
disk_label.pack()
bytes_sent_label = tkinter.Label(window, text="封包發送: ", font=("Arial", 16), anchor='w', bg="black", fg="orange")
bytes_sent_label.pack()
bytes_recv_label = tkinter.Label(window, text="封包接收: ", font=("Arial", 16), anchor='w', bg="black", fg="orange")
